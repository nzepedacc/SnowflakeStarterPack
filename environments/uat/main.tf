...
# ENVIRONMENT: UAT
# =============================================================================
# Misma estructura que DEV; cambia el sufijo a UAT (ERP_UAT, WH_ANALYTICS_UAT, etc.).
# =============================================================================
...
locals {
  ...
  functional_roles_uat = {
    FR_DATA_ANALYST  = ["OR_WRITE_ERP_FINANCE_UAT", "OR_WRITE_CRM_CUSTOMERS_UAT", "OR_WRITE_SCM_LOGISTICS_UAT"]
    FR_DATA_ENGINEER = ["OR_ADMIN_ERP_FINANCE_UAT", "OR_ADMIN_CRM_CUSTOMERS_UAT", "OR_ADMIN_SCM_LOGISTICS_UAT"]
    FR_DATA_ADMIN    = ["OR_ADMIN_ERP_FINANCE_UAT", "OR_ADMIN_CRM_CUSTOMERS_UAT", "OR_ADMIN_SCM_LOGISTICS_UAT"]
    FR_READONLY      = []
  }
  warehouse_config = {
...
module "rbac" {
  ...
  functional_roles = local.functional_roles_uat
  users = [
